...
import FormSegments from "./FormSegments";
  ...
  return (
    <div>
      ...
      <div className="relative w-full max-w-md mx-auto">
        ...
        <div>
          <div className="flex w-[337px] text-[#FFFFFF]">
            <button
              className="flex justify-center items-center py-[6px] px-[16px] flex-1"
              onClick={() => handleFormSection(0)}
            >
              Images
            </button>
            <button
              className="flex justify-center items-center py-[6px] px-[16px] flex-1"
              onClick={() => handleFormSection(1)}
            >
              Answers
            </button>
            <button
              className="flex justify-center items-center py-[6px] px-[16px] flex-1"
              onClick={() => handleFormSection(2)}
            >
              Segments
            </button>
          </div>
          <div
            className={`w-[33.33%] h-[2px] bg-[#573CFA] translate-x-[${
              100 * formSection
            }%] transition-all duration-500`} style={{ transform: `translateX(${100 * [formSection]}%)` }}
          ></div>
        </div>
      </div>
